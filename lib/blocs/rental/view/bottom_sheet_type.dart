...
class BottomSheetRadioType extends StatefulWidget {
  BottomSheetRadioType(
  ...
  @override
  _BottomSheetRadioType createState() => _BottomSheetRadioType();
}

class _BottomSheetRadioType extends State<BottomSheetRadioType> {
  bool _switchValue;
