...
class BottomSheetChooseAddress extends StatefulWidget {
  ...
  @override
  _BottomSheetChooseAddress createState() => _BottomSheetChooseAddress();
}

class _BottomSheetChooseAddress extends State<BottomSheetChooseAddress> {
  bool _switchValue;
                            ...
                            return Container(
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.pop(
                                      context,
                                      state.address[num].address +
                                          " , " +
                                          state.address[num].title);
                                },
